    ...
    <script>
        ...
        function updateAhli() {
            ...
            for (var p = 0; p < splitP.length - 1; p++) {
                ...
                newSenP = newSenP + '<tr style="border: 1px solid #EEEEEE;"><td style="border: 1px solid #EEEEEE;">' + bil +'</td><td style="border: 1px solid #EEEEEE;">' 
                        + agensi + '</td><td style="border: 1px solid #EEEEEE;">' 
                        + vot + '</td><td style="border: 1px solid #EEEEEE;">' 
                        + peruntukan + '</td>' + '</td><td style="border: 1px solid #EEEEEE;">' 
                        + tanggungan + '</td>' + '</td><td style="border: 1px solid #EEEEEE;">' 
                        + belanja + '</td>'
                    + '<td style="border: 1px solid #EEEEEE;"> <button type="button" class="btn btn-sm btn-danger" id="btnRemoveAhli' + p +
