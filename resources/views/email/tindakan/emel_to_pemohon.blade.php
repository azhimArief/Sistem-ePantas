...
<body>
    ...
    <h3 style="text-transform: uppercase">NOTIFIKASI STATUS PERMOHONAN EPANTAS</h3>
    ...
    <justify>
        ...
        <p> 
            <table width="80%" border="0" style="border-collapse:collapse; text-align:left; margin:0px 0px 0px 40px;" cellpadding="3" >
                ...
                <tr>
                    <th style="text-align:left">Kos Mohon</th>
                    <td><strong>: RM{{ number_format($contentEmel->kosMohon, 2) }} </strong></td>
                </tr>
                @if ( $contentEmel->id_status == 9)
                    <tr>
                        <th style="text-align:left">Kos Lulus</th>
                        <td><strong>: RM{{ number_format($contentEmel->kosSebenar, 2) }} </strong></td>
                    </tr>
                @endif
                <tr>
