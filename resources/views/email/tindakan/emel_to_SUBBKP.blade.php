...
<body>
    ...
    <p>2. &emsp;Dimaklumkan bahawa terdapat permohonan baru untuk makluman tindakan pihak YBhg. Datuk Seri/ Dato’/ Datuk/ Datin/ Tuan/ Puan. Butiran permohonan adalah seperti berikut: </p>
    ...
    <p>
        3. &emsp;Sehubungan dengan itu, mohon kerjasama YBhg. Datuk Seri/ Dato’/ Datuk/ Datin/ Tuan/ Puan untuk mengakses 
        <a href="{{ url('/peruntukan/butiran/' . $contentEmel->idMaklumatPermohonan) }}">ePantas</a> 
        dalam memberikan tindakan seterusnya. 
    </p>
    ...
    <p>
        <h7>{{ $pentadbirKewangan->nama }}
        <br> {{ $pentadbirKewangan->jawatan }}
        <br> {{ $pentadbirKewangan->bahagian }}
        <br> {{ $pentadbirKewangan->agensi }}
