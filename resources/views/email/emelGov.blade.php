...
<body>
    ...
    {{-- <p>1.  Pengesahan pendaftaran untuk sistem ePantas boleh dilakukan dengan menekan pautan berikut: <a href="{{ url('/daftar/daftarGov/' . $content) }}">Pendaftaran Akaun</a> </p> --}}
    <p>1. Pengesahan pendaftaran untuk sistem ePantas boleh dilakukan dengan menekan pautan berikut:</p>

    <!-- Styled button -->
    <p style="text-align: left;">
        &nbsp;&nbsp;&nbsp;
        <a href="{{ url('/daftar/daftarGov/' . $content) }}" 
