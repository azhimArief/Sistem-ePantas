        ...
        <div class="container-fluid">
            <div class="col-xl-13 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('peruntukan.kemaskini_simpanvot', $maklumats->idMaklumatPermohonan) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="table-responsive">
                                    <table id="example1" class="table table-sm table-bordered" style="width:98%;margin-left:10px;">
                                                    ...
                                                    <td width="10%">
                                                        <center>
                                                            <div class="btn-group">
                                                                ...
                                                                <a
                                                                    href="{{ route('peruntukan.kemaskiniVotForm', $vot->idVotByAdmin) }}"
                                                                    class="btn btn-sm btn-success" style='color:white;'>
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a
                                                                    href="{{ route('peruntukan.buang_vot', $vot->idVotByAdmin) }}"
                        ...
                        <div class=" justify-content-center">
                            <a href="{{ url('peruntukan/kemaskini/' . $maklumats->idMaklumatPermohonan) }}" style="color: black;"
