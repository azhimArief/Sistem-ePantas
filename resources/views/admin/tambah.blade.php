        ...
        <div class="container-fluid">
            <div class="col-xl-13 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {{-- <form method="POST" action="{{ route('peruntukan.simpanT') }}" enctype="multipart/form-data"> --}}
                        <div class="basic-form">

                            <form method="POST" name="tambahForm" id="tambahForm" action="{{ route('peruntukan.simpanT') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}

                                <div class="default-tab">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link @if ( !$errors->any() ){ active } @endif" data-toggle="tab" href="#pemohon"><i
                                        ...
                                        {{-- <li class="nav-item">
                                            <a class="nav-link @if ($errors->any()){ active } @endif " data-toggle="tab" href="#maklumat"><i
                                    ...
                                    <div class="tab-content">
                                        ...
                                        {{-- MAKLUMAT PEMOHON --}}
                                        <div class="tab-pane fade @if ( !$errors->any() ){ show active } @endif" id="pemohon" role="tabpanel">
                                            <br>
                                            <br>

                                            <div class="form-group row">
                                                <label for="nama" class="col-sm-3 col-form-label" style="text-align:left">
                                                    Carian Nama <i class="fa fa-search" aria-hidden="true"></i>
                                                    <div class="hover-text">
                                                        <i class="fa fa-info-circle" aria-hidden="true"></i>
                                                        <span class="tooltip-text" id="right"> Pastikan pemohon telah menciptakan akaun terlebih dahulu.</span>
                                                    </div>
                                                </label>
                                                <div class="input-group col-sm-9 ">
                                                   <select class="select2 nama" id="cariNama" name="cariNama" style="width: 100%; text-align:left;" required>
                                                        <option value="" @if (old('cariNama') == '') {{ 'selected="selected"' }} @endif>&nbsp; </option>
                                                        @foreach ($users as $user)
                                                            <option value="{{ $user->id }}" data-agensi="{{ $user->agensi }}"
                                                                @if (old('cariNama') == $user->id) {{ 'selected="selected"' }} @endif>
                                                                {{ $user->nama }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="agensi"
                                                        name="agensi" placeholder="" value="{{ old('agensi') }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="bahagian"
                                                        name="bahagian" placeholder="" value="{{ old('bahagian') }}">
                                                    {{-- value="{{ $personel->bahagian_id != '' ? \App\PLkpBahagian::find($personel->bahagian_id)->bahagian : old('bahagian') }}" readonly> --}}
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" id="telefon"
                                                        name="telefon" placeholder="" value="{{ old('telefon') }}">
                                            ...
                                            <div class="float-right">
                                                ...
                                                <br>
                                                <button type="submit" id="simpan_pemohon" name="simpan_pemohon" class="btn btn-primary float-right btn-sm"><i class="fa fa-arrow-right" aria-hidden="true"></i> |
                                                    Seterusnya
                                                </button>
                                            </div>
                                        ...
                                        {{-- MAKLUMAT PERMOHONAN --}}
                                        <div class="tab-pane fade @if ($errors->any()){ show active } @endif" id="maklumat">
                                            <br>
                                            <br>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6" style="@if ($errors->has('perancangan')) border: 2px solid red; @endif">
                                                    <label class="radio-inline mr-3">
                                                        <input type="radio" name="perancangan" value="1"
                                                            {{ old('perancangan') == '1' ? 'checked' : '' }}>
                                                        Dalam Perancangan Perolehan Tahunan
                                                    </label>
                                                    <br>
                                                    <label class="radio-inline mr-3">
                                                        <input type="radio" name="perancangan" value="2"
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="form-control" id="tkh_mula"
                                                            name="tkh_mula" value="{{ old('tkh_mula') }}">
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group">
                                                        <input type="date" class="form-control" id="tkh_tamat"
                                                            name="tkh_tamat" value="{{ old('tkh_tamat') }}">
                                                    </div>
                                            ...
                                            <div id="pengesahDiv" style="display:none;">
                                                <br>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="agensi_pengesah" name="agensi_pengesah" value="{{ old('agensi_pengesah') }}">
                                                        </div>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                <td colspan="7" align="right">
                                                                    ...
                                                                    <a
                                                                        class="btn btn-sm btn-primary" style='color:white;'
                                                                        data-toggle="modal" data-target="#modal-vot" id="votButton"><i
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group input-secondary">
                                                        ...
                                                        <input type="number" class="form-control" name="kos_mohon"
                                                            id="kos_mohon" placeholder="" value="{{ old('kos_mohon') }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
...
@section('script')
        ...
        <script type="text/javascript">
            ...
            //IF PEMOHON KPN NOSHOW DIVPENGESAH ELSE SHOW
                function checkAgensi(selectedAgensi) {
                    console.log(selectedAgensi);
                    // Check if the selected agensi is "Kementerian Perpaduan Negara"
                    if (selectedAgensi === 'Kementerian Perpaduan Negara (KPN)') {
                        // Hide the div if it's Kementerian Perpaduan Negara
                        $('#pengesahDiv').hide();
                    } else {
                        // Show the div for other agensi
                        $('#pengesahDiv').show();
                    }
                }
                ...
                $(document).ready(function() {
                    ...
                    var initialAgensi = $('#cariNama option:selected').data('agensi');
                    checkAgensi(initialAgensi);

                    // Attach a change event listener to the select element
                    $('#cariNama').on('change', function() {
                        // Get the selected option's agensi attribute
                        var selectedAgensi = $(this).find('option:selected').data('agensi');
                        // Check and update the display of the div
                        checkAgensi(selectedAgensi);
                    });
                });
            //IF PEMOHON KPN NOSHOW DIVPENGESAH ELSE SHOW
