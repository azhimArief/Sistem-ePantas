                            ...
                            <div class="col-12 nextPage" style=" margin-right: 4.1mm; page-break-after: always; page-break-inside: avoid;">
                                ...
                                @if ( $tindakanPengesah )
                                    @if ( $pemohon->agensi != 'Kementerian Perpaduan Negara (KPN)')
                                        ...
                                        <dl class="row mb-4" style="text-align: left; width: auto; position: absolute; right: 40;">
                                            <br>
                                            ...
                                            <dd class="col-sm-11"  style="text-align: justify;">Tarikh : {{ Carbon\Carbon::parse($tindakanPengesah->CreatedAt)->format('d.m.Y') }}</dd>
                                        </dl>
                                ...
                                @if ( $tindakanLulus )
                                    ...
                                    <dl class="row mb-4" style="text-align: left; width: auto; position: absolute; right: 0;">
                                        ...
                                        <dd class="col-sm-11"  style="text-align: justify;">Tarikh : {{ Carbon\Carbon::parse($tindakanLulus->CreatedAt)->format('d.m.Y') }}</dd>
                                    </dl>
                                @else
                                    <br><br><br><br><br>
                                @endif
