        ...
        <div class="container-fluid">
            <div class="col-xl-13 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('peruntukan.tindakan_simpanvot', $maklumats->idMaklumatPermohonan) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="table-responsive">
                                    <table id="example1" class="table table-sm table-bordered" style="width:99%;margin-left:10px;">
                                                        ...
                                                        <center>
                                                            <div class="btn-group">
                                                                {{-- <center> --}}
                                                                    ...
                                                                    <a
                                                                        href="{{ route('peruntukan.tindakanVotForm', $vot->idVotByAdmin) }}"
                                                                        class="btn btn-sm btn-success" style='color:white;'>
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <a
                                                                        href="{{ route('peruntukan.tindakanBuangVot', $vot->idVotByAdmin) }}"
