            ...
            <div class="col-xl-13 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">    
                        ...
                        <h3 class="font-w600 title mb-2 mr-auto">Tindakan Kewangan</h3>
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form-horizontal" method="POST" action="{{ url('/peruntukan/tindakan/simpan/' . $maklumats->idMaklumatPermohonan) }}" enctype="multipart/form-data" id="PenumpangForm">
                                {{ csrf_field() }}

                                <div class="form-group row">
                                    <label for="vot" class="col-sm-3 col-form-label" style="text-align:left"> 
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="7" align="right">
                                                        <a
                                                            href="{{ route('peruntukan.tindakan_vot', $maklumats->idMaklumatPermohonan) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group mb-0">
                                            <label class="radio-inline mr-3"><input type="radio" name="status" value="13"  {{ old('status') == '13' ? 'checked' : '' }}> 
                                                Ada
                                            </label>
                                            <label class="radio-inline mr-3"><input type="radio" name="status" value="14" {{ old('status') == '14' ? 'checked' : '' }}> 
                                                Tiada
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="select2" id="punca" name="punca" style="width: 100%; text-align:left">
                                            <option value=""@if (old('punca') == '') {{ 'selected="selected"' }} @endif>&nbsp;</option>
                                            <option value="B14" {{ old('punca') == 'B14' ? 'selected' : '' }}>B14 - Kementerian Perpaduan Negara </option>
                                            <option value="B11" {{ old('punca') == 'B11' ? 'selected' : '' }}>B11 - Kementerian Kewangan</option>
                                        </select>
                                ...
                                {{-- <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group input-secondary">
                                            ...
                                            <input type="number" class="form-control" name="kos_lulus" id="kos_lulus" step="0.5" value="{{ old('kos_lulus') }}">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea id="ulasan" name="ulasan" type="text" class="form-control" rows="4" value="{{ old('ulasan') }}"
                                            placeholder="">{{ old('ulasan') }}</textarea>
                                        @error('ulasan') <div class="text-danger text-strong">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                ...
                                <div class="btn-group float-right">
                                    ...
                                    <button type="submit" name="semak_semula" class="btn btn-warning btn-sm float-right">
                                        <i class="fa fa-share-square" aria-hidden="true"></i> | Semak Semula
                                    </button>
                                    <button type="submit" name="hantar" class="btn btn-success btn-sm float-right">
                                        <i class="fa fa-paper-plane" aria-hidden="true"></i> | Hantar
                                    </button>
                                    {{-- <button type="submit" name="hantar" class="btn btn-success btn-sm float-right">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <dl class="row">
                                                ...
                                                <dd class="col-sm-9" style="text-align: justify;"> {{ $maklumats->namaProgram }} </dd>
                                                ...
                                                <dd class="col-sm-8"> RM {{ number_format($maklumats->kosMohon, 2) }} </dd>
...
@section('script')
        ...
        @elseif($errors->has('punca'))
            <script>
                document.getElementById("punca").focus();
            </script>
        @elseif($errors->has('ulasan'))
            <script>
                document.getElementById("ulasan").focus();
            </script>
        @endif
