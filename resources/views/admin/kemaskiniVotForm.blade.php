        ...
        <div class="container-fluid">
            <div class="col-xl-13 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('peruntukan.kemaskiniVotFormS', $vot->idVotByAdmin) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class=" justify-content-center">
                                ...
                                <a href="{{ url('peruntukan/kemaskini/vot/' . $vot->idMaklumatPermohonan) }}" style="color: black;"
