        ...
        <div class="container-fluid">
            <div class="col-xl-13 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('peruntukan.tindakan_simpanvotK', $maklumats->idMaklumatPermohonan) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <table id="example1" class="table table-sm table-responsive-sm table-bordered" style="width:99%;margin-left:10px;">
                                                ...
                                                <td width="10%">
                                                    <center>
                                                        <div class="btn-group">
                                                            ...
                                                            <a
                                                                href="{{ route('peruntukan.tindakanVotFormK', $vot->idVotByAdmin) }}"
                                                                class="btn btn-sm btn-success" style='color:white;'>
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                            <a
                                                                href="{{ route('peruntukan.tindakanBuangVotK', $vot->idVotByAdmin) }}"
                                                        ...
                                                        {{-- <form class="form-horizontal" method="POST" action=""
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="perkaraK" id="perkaraK" value="{{ old('perkaraK') ?? $vot->perkara }}">
                                                                    </div>
                                                                </div>
