        ...
        <div class="container-fluid">
            <div class="col-xl-13 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('peruntukan.tindakanVotFormSaveK', $vot->idVotByAdmin) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="lainK" id="lainK" value="{{ $vot->keterangan }}">
                                ...
                                <div class="btn-group float-right">
                                    ...
                                    <a href="{{ url('peruntukan/kemaskini/tindakan/vot/' . $vot->idMaklumatPermohonan) }}"
