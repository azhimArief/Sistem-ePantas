        ...
        <div class="container-fluid">
            <div class="col-xl-13 col-lg-12">
                <div class="card">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ url('/peruntukan/simpan/batal/'.$maklumats->idMaklumatPermohonan) }}" enctype="multipart/form-data">        
                        {{ csrf_field() }}
                        ...
                        <div class="card-body">
                            ...
                            <div class="btn-group float-right">
                                ...
                                <a href="{{ url('peruntukan/butiran/' . $maklumats->idMaklumatPermohonan) }}" class="btn btn-default float-right" style="color: black;">
