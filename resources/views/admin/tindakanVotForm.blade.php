        ...
        <div class="container-fluid">
            <div class="col-xl-13 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('peruntukan.tindakanVotFormS', $vot->idVotByAdmin) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div class="btn-group float-right">
                                    ...
                                    <a href="{{ url('peruntukan/tindakan/vot/' . $vot->idMaklumatPermohonan) }}"
