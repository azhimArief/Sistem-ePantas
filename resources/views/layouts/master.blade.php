...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            ...
            <span class="brand-logo">
                ...
                @if (Auth::check())
                    <a href="{{ url('pemohon/menu/'. Auth::user()->id) }}" style="display: flex; align-items: center; text-decoration: none;">
                        <img src="{{ asset('images/JataNegara.png') }}" alt="Jata Negara" width="55" height="50" style="margin-right: 10px;">
                        <p class="brand-title" style="font-size: 20px; color: black; margin: 0;">ePantas</p>
                    </a>
                @else
                @endif
                        ...
                        <ul class="navbar-nav header-right main-notification">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <div style="cursor: pointer;">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{ url('pemohon/profil/' . Auth::user()->id) }}">
                            ...
                            {{-- <li class="nav-item dropdown header-profile">
                                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item ai-icon">
                                    <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                                    <span class="ml-2">Log Keluar </span>
                                </a> 
    ...
    ***********************************-->
    ...
    {{-- <script src="{{ asset('/vendor/bootstrap-daterangepicker/daterangepicker.js') }}" defer></script> --}}

    <!-- Daterangepicker -->
    {{-- <script src="{{ asset('/js/plugins-init/bs-daterange-picker-init.js') }}" defer></script> --}}

    <!-- Testtttt daterangepicker -->
