...
@section('content')
    ...
    @endif
    @if ($errors->has('justifikasiPermohonan'))
        <style>
            #justifikasiPermohonan {
                border-color: red;
                border-width: 2px;
            }
        </style>
    @endif
    @if ($errors->has('ulasanBahagian'))
        <style>
            #ulasanBahagian {
                border-color: red;
                border-width: 2px;
            ...
            <div class="col-xl-13 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        {{-- <h4 class="card-title">Kemaskini Borang Permohonan Peruntukan</h4> --}}
                        <h3 class="font-w600 title mb-2 mr-auto">Permohonan Peruntukan</h3>
                        ...
                        {{-- <h4 class="card-title">{{ $maklumats->id_status }}</h4> --}}
                    </div>
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="POST" name="kemaskiniForm" id="kemaskiniForm" action="{{ route('pemohon.simpanK', $maklumats->idMaklumatPermohonan) }}" enctype="multipart/form-data" spellcheck="false">
                                {{ csrf_field() }}
                                ...
                                <div class="default-tab">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade @if( $errors->any() || session('status') ){ show active } @endif" id="maklumat">
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                <td colspan="7" align="right">
                                                                    ...
                                                                    <a
                                                                        href="{{ route('pemohon.kemaskini_vot', $maklumats->idMaklumatPermohonan) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    @if ( $maklumats->doc_Sokongan)
                                                        <small>
                                                            {{-- <a href="{{ url(''. $maklumats->doc_Sokongan) }}" class="btn-sm btn-default" target="_blank" ><i class="fa fa-paperclip"></i> &nbsp; {{ basename($maklumats->doc_Sokongan) }}</a> --}}
                                            ...
                                            {{-- <p style="color: red; font-weight: bold;">* Sila semak format dalam 'Papar PDF' untuk memastikan format dan maklumat telah dimasukkan dengan lengkap dan baik.</p> --}}
                                            ...
                                            <div class="btn-group float-right">
                                                ...
                                                @if ( $maklumats->id_status == 11 )
                                                    {{-- HANTAR SEMAK SEMULA KE PENGESAH --}}
                                                    <button type="submit" name="hantar_semula_pengesah" id="hantar_semula_pengesah" class="btn btn-info float-right btn-sm" >
                                                        <i class="fa fa-paper-plane"></i> | Hantar
                                                    </button>
                                                @endif

                                                @if ( $maklumats->id_status == 22 )
                                                    {{-- HANTAR SEMAK SEMULA KE PENTADBIR --}}
                                                    <button type="submit" name="hantar_semula_pentadbir" id="hantar_semula_pentadbir" class="btn btn-info float-right btn-sm" >
                                                        <i class="fa fa-paper-plane"></i> | Hantar
                                                    </button>
                                                @endif
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <textarea class='form-control summernote' name="objektif1" id="objektif1" cols="" rows="2">{{ $objektifs->obj1 ?? old('objektif1') }} </textarea>
                                                        </div>
                                                    </div>
...
@section('script')
            ...
            <script>
                $(document).ready(function () {
                    ...
                    function loadTujuans() {
                        // $.get(`/tujuan/${idMaklumatPermohonan}`, function (data) {
                    ...
                    $(document).on('click', '.edit-tujuan', function (event) {
                        ...
                        $.ajax({
                            // url: `/tujuan/show/${editId}`, // Assuming this route returns the specific tujuan data
            ...
            <script>
                $(document).ready(function () {
                    ...
                    function loadLatarBelakangs() {
                        // $.get(`/latar/${idMaklumatPermohonan}`, function (data) {
            ...
            <script>
                $(document).ready(function () {
                    ...
                    function loadDasarSemasas() {
                        // $.get(`/dasar/${idMaklumatPermohonan}`, function (data) {
            ...
            <script>
                $(document).ready(function () {
                    ...
                    function loadJustifikasiPermohonans() {
                        // $.get(`/justifikasi/${idMaklumatPermohonan}`, function (data) {
            ...
            <script>
                $(document).ready(function () {
                    ...
                    function loadUlasanBahagians() {
                        // $.get(`/ulasan/${idMaklumatPermohonan}`, function (data) {
        ...
        <script type="text/javascript">
            ...
            //         'x|x' + $('#objekAm').select2('data')[0].title + //NO VOT AM
            ...
            //         var perkara = column[1];
            //         var objekAmId = column[2]; //NO ID OA
            ...
            //OBJEKTIF LIST
            function tambahOBJ() {
                var form_OBJ = btoa('x|x' + $('#objektif').val()) + '|x|x|';

                $('#form_OBJ').val($('#form_OBJ').val() + form_OBJ);
            ...
            function updateOBJ() {
                var newSenP = '';
                var splitP = $('#form_OBJ').val().split('|x|x|');
                for (var p = 0; p < splitP.length - 1; p++) {
                    var bil = p + 1;
                    var column = atob(splitP[p]).split('x|x');
                    console.log(column);

                    var objektif = column[1];

                    newSenP = newSenP +
                        '<tr style="border: 1px solid #EEEEEE;"><td style="border: 1px solid #EEEEEE;text-align:center;">' +
                        bil + '.</td><td style="border: 1px solid #EEEEEE;text-align:center;">' +
                        objektif +  '</td>' +
                        '<td style="border: 1px solid #EEEEEE;text-align:center;"> <button type="button" class="btn btn-sm btn-danger" id="btnRemoveObjektif' +
                        p +
                        '" onclick="removeOBJ(' + p + ');" title="' + splitP[p] +
                        '"><i class="fa fa-trash"></i></button></td></tr>';
                }
                $('#senOBJ').html(newSenP);
            ...
            function removeOBJ(p1) {
                var form_OBJ = '';
                var splitP = $('#form_OBJ').val().split('|x|x|');
                for (var p = 0; p < splitP.length - 1; p++) {
                    if (p1 != p) {
                        form_OBJ += splitP[p] + '|x|x|';
                    }
                }
                $('#form_OBJ').val(form_OBJ);
                updateOBJ();
            }
        ...
        {{-- AUTOSAVE --}}
            <script type="text/javascript">
                ...
                function updateButtonTime() {
                    ...
                    var formattedTime = currentTime.toLocaleString('en-GB', { timeZone: 'Asia/Kuala_Lumpur', hour: 'numeric', minute: 'numeric', hour12: true, day: 'numeric', month: 'numeric', year: 'numeric' });
