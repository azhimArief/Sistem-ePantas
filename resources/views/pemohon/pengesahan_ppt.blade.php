                        ...
                        <div class="card-body">
                            ...
                            <div class="basic-form">                                    
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex justify-content-center">
                                                                                ...
                                                                                <a href="{{ url('pemohon/buangPPT/' . $program1->idProgramDirancang . '/' . $personel->nokp) }}" title="Buang" 
                                                                                    class="btn btn-sm btn-rounded btn-danger"><i class="fas fa-trash"></i>
                                                                                </a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        {{-- MODAL1 --}}
                                                            <div class="modal fade" id="modal-default1-{{ $program1->idProgramDirancang }}">
                                                                <div class="modal-dialog modal-xl">
                                                                    ...
                                                                    <form class="form-horizontal" method="POST" action="{{ route('pemohon.simpan_kemaskiniPPT', ['id' => $program1->idProgramDirancang, 'id2' => $program1->idProgramDirancang , 'nokp' => $personel->nokp] ) }}"
                                                                ...
                                                                <td colspan="6"> 
                                                                    <center>
                                                                        <button type="button" title="Tambah" class="btn btn-sm btn-rounded float-right btn-primary" 
                                                                            data-toggle="modal" data-target="#modal-tambah1-{{ $program1->idPermohonan }}"">
                                                                            <i class="fas fa-plus"></i> Tambah</button>
                                                                    </center>
                                                                </td>
                                                            </tr>
                                                            {{-- MODAL1 TAMBAH--}}
                                                            <div class="modal fade" id="modal-tambah1-{{ $program1->idPermohonan }}">
                                                                <div class="modal-dialog modal-xl">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-purple">
                                                                        ...
                                                                        <form class="form-horizontal" method="POST" action="{{ route('pemohon.pengesahan_tambahPPT', ['id' => $program1->idPerancanganPerolehan , 'nokp' => $personel->nokp] ) }}" enctype="multipart/form-data" id="myForm1">
                                                                            {{ csrf_field() }}
                                                                            <div class="modal-body">
                                                                                <input type="hidden" name="bahagian" value="{{ $program1->bahagian }}">
                                                                                <input type="hidden" name="tahun" value="{{ $program1->tahunPPT }}">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex justify-content-center">
                                                                                        ...
                                                                                        <a href="{{ url('pemohon/buangPPT/' . $program2->idProgramDirancang . '/' . $personel->nokp) }}" title="Buang" 
                                                                                            class="btn btn-sm btn-rounded btn-danger"><i class="fas fa-trash"></i></a>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                        ...
                                                        @foreach ($programs as $program2)
                                                            ...
                                                            <div class="modal fade" id="modal-default2-{{ $program2->idProgramDirancang }}">
                                                                <div class="modal-dialog modal-xl">
                                                                    ...
                                                                    <form class="form-horizontal" method="POST" action="{{ route('pemohon.simpan_kemaskiniPPT', ['id' => $program2->idProgramDirancang, 'id2' => $program2->idProgramDirancang , 'nokp' => $personel->nokp] ) }}" enctype="multipart/form-data" id="myForm2">
                                                                        {{ csrf_field() }}
                                                                        <div class="modal-body">
                                                        ...
                                                        @if($loop->last)
                                                            ...
                                                            <tr>
                                                                <td colspan="7"> 
                                                                    <center>
                                                                        <button type="button"  title="Tambah" class="btn btn-sm btn-rounded float-right btn-primary" 
                                                                            data-toggle="modal" data-target="#modal-tambah2-{{ $program2->idPermohonan }}"">
                                                                            <i class="fas fa-plus"></i> Tambah</button>
                                                                    </center>
                                                                </td>
                                                            </tr>
                                                            {{-- MODAL2 TAMBAH--}}
                                                            <div class="modal fade" id="modal-tambah2-{{ $program2->idPermohonan }}">
                                                                <div class="modal-dialog modal-xl">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-purple">
                                                                            <h4 class="modal-title">TAMBAH PERBELANJAAN PERUNTUKAN</h4>
                                                                        ...
                                                                        <form class="form-horizontal" method="POST" action="{{ route('pemohon.pengesahan_tambahPPT', ['id' => $program2->idPerancanganPerolehan , 'nokp' => $personel->nokp] ) }}" enctype="multipart/form-data" id="myForm1">
                                                                            {{ csrf_field() }}
                                                                            <div class="modal-body">
                                                                                <input type="hidden" name="bahagian" value="{{ $program2->bahagian }}">
                                                                                <input type="hidden" name="tahun" value="{{ $program2->tahunPPT }}">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex justify-content-center">
                                                                            ...
                                                                            <a href="{{ url('pemohon/buangPPT/' . $program3->idProgramDirancang . '/' . $personel->nokp) }}" title="Buang" 
                                                                                class="btn btn-sm btn-rounded btn-danger"><i class="fas fa-trash"></i></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        @foreach ($programs as $program3)
                                                            ...
                                                            <div class="modal fade" id="modal-default3-{{ $program3->idProgramDirancang }}">
                                                                <div class="modal-dialog modal-xl">
                                                                    ...
                                                                    <form class="form-horizontal" method="POST" action="{{ route('pemohon.simpan_kemaskiniPPT', ['id' => $program3->idProgramDirancang, 'id2' => $program3->idProgramDirancang , 'nokp' => $personel->nokp] ) }}" enctype="multipart/form-data" id="myForm2">
                                                                        {{ csrf_field() }}
                                                                        <div class="modal-body">
                                                        ...
                                                        @if($loop->last)
                                                            ...
                                                            <tr>
                                                                <td colspan="7"> 
                                                                    <center>
                                                                        <button type="button"  title="Tambah" class="btn btn-sm btn-rounded float-right btn-primary" 
                                                                            data-toggle="modal" data-target="#modal-tambah3-{{ $program3->idPermohonan }}"">
                                                                            <i class="fas fa-plus"></i> Tambah</button>
                                                                    </center>
                                                                </td>
                                                            </tr>
                                                            {{-- MODAL3 TAMBAH--}}
                                                            <div class="modal fade" id="modal-tambah3-{{ $program3->idPermohonan }}">
                                                                <div class="modal-dialog modal-xl">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-purple">
                                                                            <h4 class="modal-title">TAMBAH PERBELANJAAN PERUNTUKAN</h4>
                                                                        ...
                                                                        <form class="form-horizontal" method="POST" action="{{ route('pemohon.pengesahan_tambahPPT', ['id' => $program3->idPerancanganPerolehan , 'nokp' => $personel->nokp] ) }}" enctype="multipart/form-data" id="myForm1">
                                                                            {{ csrf_field() }}
                                                                            <div class="modal-body">
                                                                                <input type="hidden" name="bahagian" value="{{ $program3->bahagian }}">
                                                                                <input type="hidden" name="tahun" value="{{ $program3->tahunPPT }}">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex justify-content-center">
                                                                                ...
                                                                                <a href="{{ url('pemohon/buangPPT/' . $program4->idProgramDirancang . '/' . $personel->nokp) }}" title="Buang" 
                                                                                    class="btn btn-sm btn-rounded btn-danger"><i class="fas fa-trash"></i></a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        @foreach ($programs as $program4)
                                                            ...
                                                            <div class="modal fade" id="modal-default4-{{ $program4->idProgramDirancang }}">
                                                                <div class="modal-dialog modal-xl">
                                                                    ...
                                                                    <form class="form-horizontal" method="POST" action="{{ route('pemohon.simpan_kemaskiniPPT', ['id' => $program4->idProgramDirancang, 'id2' => $program4->idProgramDirancang , 'nokp' => $personel->nokp] ) }}" enctype="multipart/form-data" id="myForm2">
                                                                        {{ csrf_field() }}
                                                                        <div class="modal-body">
                                                                ...
                                                                <td colspan="7"> 
                                                                    <center>
                                                                        <button type="button"  title="Tambah" class="btn btn-sm btn-rounded btn-primary float-right" 
                                                                            data-toggle="modal" data-target="#modal-tambah4-{{ $program4->idPermohonan }}"">
                                                                            <i class="fas fa-plus"></i> Tambah</button>
                                                                    </center>
                                                                </td>
                                                            </tr>
                                                            {{-- MODAL4 TAMBAH--}}
                                                            <div class="modal fade" id="modal-tambah4-{{ $program4->idPermohonan }}">
                                                                <div class="modal-dialog modal-xl">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-purple">
                                                                            <h4 class="modal-title">TAMBAH PERBELANJAAN PERUNTUKAN</h4>
                                                                        ...
                                                                        <form class="form-horizontal" method="POST" action="{{ route('pemohon.pengesahan_tambahPPT', ['id' => $program4->idPerancanganPerolehan , 'nokp' => $personel->nokp] ) }}" enctype="multipart/form-data" id="myForm1">
                                                                            {{ csrf_field() }}
                                                                            <div class="modal-body">
                                                                                <input type="hidden" name="bahagian" value="{{ $program4->bahagian }}">
                                                                                <input type="hidden" name="tahun" value="{{ $program4->tahunPPT }}">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex justify-content-center">
                                                                                ...
                                                                                <a href="{{ url('pemohon/buangPPT/' . $program5->idProgramDirancang. '/' . $personel->nokp) }}" title="Buang" 
                                                                                    class="btn btn-sm btn-rounded btn-danger"><i class="fas fa-trash"></i></a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        @foreach($programs as $program5)
                                                            ...
                                                            <div class="modal fade" id="modal-default5-{{ $program5->idProgramDirancang }}">
                                                                <div class="modal-dialog modal-xl">
                                                                    ...
                                                                    <form class="form-horizontal" method="POST" action="{{ route('pemohon.simpan_kemaskiniPPT', ['id' => $program5->idProgramDirancang, 'id2' => $program5->idProgramDirancang , 'nokp' => $personel->nokp] ) }}" enctype="multipart/form-data" id="myForm5">
                                                                        {{ csrf_field() }}
                                                                        <div class="modal-body">
                                                        ...
                                                        @if($loop->last)
                                                            ...
                                                            <tr>
                                                                <td colspan="7"> 
                                                                    <center>
                                                                        <button type="button"  title="Tambah" class="btn btn-sm btn-rounded btn-primary float-right" 
                                                                            data-toggle="modal" data-target="#modal-tambah5-{{ $program5->idPermohonan }}"">
                                                                            <i class="fas fa-plus"></i> Tambah</button>
                                                                    </center>
                                                                </td>
                                                            </tr>
                                                            {{-- MODAL5 TAMBAH--}}
                                                            <div class="modal fade" id="modal-tambah5-{{ $program5->idPermohonan }}">
                                                                <div class="modal-dialog modal-xl">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-purple">
                                                                            <h4 class="modal-title">TAMBAH PERBELANJAAN PERUNTUKAN</h4>
                                                                        ...
                                                                        <form class="form-horizontal" method="POST" action="{{ route('pemohon.pengesahan_tambahPPT', ['id' => $program5->idPerancanganPerolehan , 'nokp' => $personel->nokp] ) }}" enctype="multipart/form-data" id="myForm1">
                                                                            {{ csrf_field() }}
                                                                            <div class="modal-body">
                                                                                <input type="hidden" name="bahagian" value="{{ $program5->bahagian }}">
                                                                                <input type="hidden" name="tahun" value="{{ $program5->tahunPPT }}">
                                    ...
                                    <div class=" justify-content-center">
                                        ...
                                        <form method="POST" action="{{ route('pemohon.pengesahan_ppt', ['id' => $perancangan->idPerancanganPerolehan , 'nokp' => $personel->nokp] ) }}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
