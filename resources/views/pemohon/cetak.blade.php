...
<body style="background: white;font-family:'poppins', sans-serif;">
    ...
    <div class="content-body" style="margin-left: 10.1mm; margin-right: 10.1mm; margin-bottom: 14.1mm; " >
                ...
                <div class="card" style="box-shadow: 0rem 0rem 0rem 0rem rgba(82, 63, 105, 0.05);margin-bottom:0rem">
                    <div class="card-body">
                        <div class="text-center mb-3">
                            ...
                            <div class="col-12">
                                <table style="border: 0.1px solid black; border-collapse: collapse; width: 100%; ">

                                    <tr>
                                        <th style="border: 1px solid black; padding: 8px; text-align: left;">PARA</th>
                                        <th style="border: 1px solid black; padding: 8px; text-align: left;">PERKARA</th>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid black; padding: 8px; text-align: center; vertical-align: top; font-weight: bold;">1.</td>
                                        <td style="border: 1px solid black; padding: 8px; text-align: justify;">
                                            <h4 style="vertical-align: top; text-align: left; margin-top: 4px;">TUJUAN</h4>
                                            {{-- {!! $maklumats->tujuanProgram !!} --}}
                                    ...
                                    <tr>
                                        <td style="border: 1px solid black; padding: 8px; text-align: center; vertical-align: top; font-weight: bold;">2.</td>
                                        <td style="border: 1px solid black; padding: 8px; text-align: justify; font-family: Arial, sans-serif; font-size: 12pt; line-height: 1.15;">
                                            <h4 style="vertical-align: top; text-align: left; margin-top: 4px;">LATAR BELAKANG</h4>
                                            ...
                                            @foreach ($latars as $latar)
                                                <table style="border-collapse: collapse; width: 100%;">
                                                    <tr>
                                                        ...
                                                        {{-- <td style="padding: 8px; text-align: justify; font-family: Arial, sans-serif; font-size: 12pt;">{{ strip_tags($latar->latarBelakang) }}</td> --}}
                                                        <td style="padding: 8px; text-align: justify; font-family: Arial, sans-serif; font-size: 12pt;">
                                                            {!! $latar->latarBelakang  !!}
                                                            {{-- <div style="display: inline;">{!! str_replace(['<p>', '</p>'], '', $latar->latarBelakang) !!}</div> --}}
                                                        </td>
                                                    </tr>
                                                </table>
                                            @endforeach
                                    ...
                                    <tr>
                                        <td style="border: 1px solid black; padding: 8px; text-align: center; vertical-align: top; font-weight: bold;">3.</td>
                                        <td style="border: 1px solid black; padding: 8px; text-align: justify;  font-family: Arial, sans-serif; font-size: 12pt; line-height: 1.15;">
                                            <h4 style="vertical-align: top; text-align: left; margin-top: 4px;">DASAR SEMASA</h4>
                                            {{-- {!! $maklumats->dasarSemasa !!} --}}
                                            @foreach ($dasars as $dasar)
                                                <table style="border-collapse: collapse; width: 100%;">
                                                    <tr>
                                                        ...
                                                        {{-- <td style="padding: 8px; text-align: justify; font-family: Arial, sans-serif; font-size: 12pt;">{{ strip_tags($dasar->dasarSemasa) }}</td> --}}
                                                        <td style="padding: 8px; text-align: justify; font-family: Arial, sans-serif; font-size: 12pt;">{!! $dasar->dasarSemasa !!}</td>
                                                    </tr>
                                                </table>
                                            @endforeach
                                        </td>
                                    ...
                                    <tr> 
                                        <td style="border: 1px solid black; padding: 8px; text-align: center; vertical-align: top; font-weight: bold;">4.</td>
                                        <td style="border: 1px solid black; padding: 8px; text-align: justify;  font-family: Arial, sans-serif; font-size: 12pt; line-height: 1.15;">
                                            <h4 style="vertical-align: top; text-align: left; margin-top: 4px;">JUSTIFIKASI PERMOHONAN</h4>
                                            {{-- {!! $maklumats->justifikasiPermohonan !!} --}}
                                            @foreach ($justifikasis as $justifikasi)
                                                <table style="border-collapse: collapse; width: 100%;">
                                                    <tr>
                                                        ...
                                                        {{-- <td style="padding: 8px; text-align: justify; font-family: Arial, sans-serif; font-size: 12pt;">{{ strip_tags($justifikasi->justifikasiPermohonan) }}</td> --}}
                                                        <td style="padding: 8px; text-align: justify; font-family: Arial, sans-serif; font-size: 12pt;">{!! $justifikasi->justifikasiPermohonan !!}</td>
                                                    </tr>
                                                </table>
                                            @endforeach
                                        </td>
                                    ...
                                    <tr>
                                        <td style="border: 1px solid black; padding: 8px; text-align: center; vertical-align: top; font-weight: bold;">5.</td>
                                        <td style="border: 1px solid black; padding: 8px; text-align: justify;  font-family: Arial, sans-serif; font-size: 12pt; line-height: 1.15;">
                                            <h4 style="vertical-align: top; text-align: left; margin-top: 4px;">ULASAN BAHAGIAN</h4>
                                            {{-- {!! $maklumats->ulasanBahagian !!} --}}
                                            @foreach ($ulasans as $ulasan)
                                                <table style="border-collapse: collapse; width: 100%;">
                                                    <tr>
                                                        ...
                                                        {{-- <td style="padding: 8px; text-align: justify; font-family: Arial, sans-serif; font-size: 12pt;">{{ strip_tags($ulasan->ulasanBahagian) }}</td> --}}
                                                        <td style="padding: 8px; text-align: justify; font-family: Arial, sans-serif; font-size: 12pt;">{!! $ulasan->ulasanBahagian !!}</td>
                                                    </tr>
                                                </table>
                                            @endforeach
                                        </td>
                                    ...
                                    <tr>
                                        <td style="border: 1px solid black; padding: 8px; text-align: center; vertical-align: top; font-weight: bold;">6.</td>
                                        <td style="border: 1px solid black; padding: 8px; text-align: justify;">
                                            <h4 style="vertical-align: top; text-align: left; margin-top: 4px;">IMPLIKASI KEWANGAN</h4>
                                    ...
                                    <tr>
                                        <td style="border: 1px solid black; padding: 8px; text-align: center; vertical-align: top; font-weight: bold;">7.</td>
                                        <td style="border: 1px solid black; padding: 8px; text-align: justify; line-height: 1.15;">
                                            {{-- <h4 style="vertical-align: top; text-align: left; margin-top: 4px;">SYOR KEMENTERIAN</h4> --}}
                                            @if ( $pemohon->agensi != 'Kementerian Perpaduan Negara (KPN)')
                                                <h4 style="vertical-align: top; text-align: left; margin-top: 4px;">SYOR JABATAN</h4>
                                                {{ $pemohon->namaBahagian }}, {{ $pemohon->agensi }} 
                                            @else
                                                <h4 style="vertical-align: top; text-align: left; margin-top: 4px;">SYOR BAHAGIAN</h4>
                            ...
                            <div class="col-12 nextPage" style=" margin-right: 4.1mm; page-break-inside: avoid;">
                                ...
                                {{-- <dl class="row mb-4" style="text-align: left; width: auto; float: right;"> --}}
                                    ...
                                    @else
                                        ...
                                        {{-- <dd class="col-sm-11"  style="text-align: justify;">Tarikh : {{ Carbon\Carbon::parse($maklumats->createdAt)->format('d.m.Y') }}</dd> --}}
