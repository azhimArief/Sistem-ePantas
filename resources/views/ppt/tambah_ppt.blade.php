                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="POST" action="{{ url('/peruntukan/simpan_ppt', $personel->nokp) }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="hidden" name="nokp" value="{{ $personel->nokp }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" name="tahun" type="number" min="2000" max="2099" step="1" value="{{ old('tahun') }}" required/>
                                            </div>
                                        </div>
                                    </div>
