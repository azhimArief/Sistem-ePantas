                ...
                <div class="col-xl-13 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h4 class="card-title">
                                ...
                                @elseif ( session('kemaskini'))
                                    Kemaskini
                                @endif --}}
                                Tindakan Perancangan Perolehan
                            </h4>
                            <?php
                        ...
                        <div class="card-body">
                            ...
                            <p>Tahun: {{ $perancangan->tahunPPT }}</p>
                            <div class="basic-form">                                    
                                    ...
                                    <div class=" justify-content-center">
                                        ...
                                        {{-- <form method="POST" action="{{ route('peruntukan.tindakan_PPT', $perancangan->idPerancanganPerolehan ) }}" enctype="multipart/form-data"> --}}
                                            {{-- {{ csrf_field() }} --}}
                                                    
                                            <button type="button" name="" class="btn btn-info float-right btn-sm" 
                                                data-toggle="modal" data-target="#modal-tindakan">
                                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i> | Tindakan
                                            </button>
                                            ...
                                            <div class="modal fade" id="modal-tindakan">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="form-horizontal" method="POST" action="{{ route('peruntukan.tindakanPPT', ['id' => $perancangan->idPerancanganPerolehan] ) }}" enctype="multipart/form-data" id="myForm1">
                                                            {{ csrf_field() }}
                                                            <div class="modal-body">
                
                                                                <div class="form-group row">
                                                                    <label for="status" class="col-sm-2 col-form-label" style="text-align:left">
                                                                        Status <font color="red">*</font>
                                                                    </label>
                                                                    <div class="col-sm-6">
                                                                        <select class="select2-with-label-single js-states d-block" id="status" name="status"
                                                                        {{-- <select id="single-select" name="bahagian" --}}
                                                                            style="width:100%; text-align:left;" required>
                                                                            <option value="0" selected disabled>&nbsp;</option>
                                                            ...
                                                            <div class="modal-footer justify-content-between">
                                                                <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Tutup</button>
                                                                {{-- <button type="button" class="btn btn-light bg-purple" id="tambah_penumpang" onclick="tambahPenumpang()" data-dismiss="modal">Tambah</button> --}}
                                                                <button type="submit" class="btn btn-info float-right btn-sm" name="simpan_tindakan"><i class="fa fa-pencil-square-o"></i> Simpan</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <!-- /.modal-content -->
