                    ...
                    <div class="card-body">
                            ...
                            <div class="col-xl-3 col-sm-6 m-t35">
                                <div class="card card-coin">
                                    <div class="card-body text-center">
                                        ...
                                        <img width="100" height="100" src="https://img.icons8.com/bubbles/100/list.png" alt="list"/>
                                        <h2 class="text-black mb-2 font-w600">{{ $jumlPermohonan }}</h2>
                                        <p class="mb-0 fs-14">
                                            Jumlah Permohonan
                                        </p>	
                                    </div>
                            ...
                            <div class="col-xl-3 col-sm-6 m-t35">
                                <div class="card card-coin">
                                    <div class="card-body text-center">
                                        ...
                                        <img width="100" height="100" src="https://img.icons8.com/bubbles/100/add.png" alt="list"/>
                                        
                                        <h2 class="text-black mb-2 font-w600">{{ $jumlBaru }}</h2>
                                        <p class="mb-0 fs-14">
                                            Permohonan Baru
                                        </p>	
                                    </div>
                            ...
                            <div class="col-xl-3 col-sm-6 m-t35">
                                <div class="card card-coin">
                                    <div class="card-body text-center">
                                        ...
                                        <img width="100" height="100" src="https://img.icons8.com/bubbles/100/save-close.png" alt="list"/>
                                        <h2 class="text-black mb-2 font-w600">{{ $jumlLulus }}</h2>
                                        <p class="mb-0 fs-14">
                                            Permohonan Lulus
                                        </p>
                                    </div>
                            ...
                            <div class="col-xl-3 col-sm-6 m-t35">
                                <div class="card card-coin">
                                    <div class="card-body text-center">
                                        ...
                                        <img width="100" height="100" src="https://img.icons8.com/bubbles/100/error.png" alt="list"/>
                                        {{-- <img width="100" height="100" src="https://img.icons8.com/bubbles/100/delete-forever.png" alt="list"/> --}}
                                        <h2 class="text-black mb-2 font-w600">{{ $jumlGagal }}</h2>
                                        <p class="mb-0 fs-14">
                        ...
                        {{-- <div class="row mb-3">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <iframe title="analisisprogram" width="100%" height="600"  src="https://app.powerbi.com/view?r=eyJrIjoiN2I0NmUzNmYtZjUwYS00MGU5LTkzMmQtOTMwZTczM2M4ZDY2IiwidCI6Ijk3YWIyZDBjLWQ0YmItNGQ4Ni1hNjUwLTE4MDRhOGRkMzY0OSIsImMiOjEwfQ%3D%3D"
                                                    frameborder="0" style="background-color:#EEEEEE" allowFullScreen="true"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>  --}}
